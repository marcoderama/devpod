...
Depending on the Provider, DevPod will also automatically determine when a workspace is currently not being used and shutdown any unused resources to save costs.
